...
私は卒業前の18年間、スターバックスコーヒージャパンで店長として勤務してきました。エチオピア、コロンビア、グアテマラ、インドネシア……。
...
> 18年間「カップの中のコーヒー」を見つめてきた私が、学びを経て「宇宙から地球上のコーヒー」を見つめる。
...
| 気温  | ERA5-Land     | 約11km  | 年平均気温（2020-2023平均） |
| 降水量 | CHIRPS        | 約5.5km | 年降水量（2020-2023平均）  |
...
[![国別比較](https://github.com/Mitsuaki-1004/coffee-2050-projection/raw/main/outputs_2050/area_change_comparison.png)](/Mitsuaki-1004/coffee-2050-projection/blob/main/outputs_2050/area_change_comparison.png)

| 国         | 現状適地(km²) | 2050適地(km²) | 変化率                |
| --------- | --------- | ----------- | ------------------ |
| 🇯🇵 日本     | 19,506    | 52,731      | **+170.3%** ⬆️⬆️⬆️ |
| 🇻🇳 ベトナム   | 302,034   | 316,907     | +4.9% ⬆️           |
| 🇨🇴 コロンビア  | 107,012   | 109,777     | +2.6% ⬆️           |
| 🇬🇹 グアテマラ  | 31,808    | 27,580      | -13.3% ⬇️          |
| 🇪🇹 エチオピア  | 354,047   | 303,409     | -14.3% ⬇️          |
| 🇹🇼 台湾     | 15,917    | 12,458      | -21.7% ⬇️⬇️        |
| 🇮🇩 インドネシア | 84,290    | 59,493      | **-29.4%** ⬇️⬇️⬇️  |
...
[![インドネシア差分マップ](https://github.com/Mitsuaki-1004/coffee-2050-projection/raw/main/outputs_2050/indonesia_diff.png)](/Mitsuaki-1004/coffee-2050-projection/blob/main/outputs_2050/indonesia_diff.png)
...
[![エチオピア差分マップ](https://github.com/Mitsuaki-1004/coffee-2050-projection/raw/main/outputs_2050/ethiopia_diff.png)](/Mitsuaki-1004/coffee-2050-projection/blob/main/outputs_2050/ethiopia_diff.png)

**南西部に大きな青エリア、東部・南東部に大きな赤エリア。** 同じ国の中で明暗が真っ二つに分かれる。

- 南西部のSidamo・Yirgachefeは**完璧化**（Yirgacheffe 0.85 → **1.00**）
- 東部の乾燥地Harrarは**衰退**（0.69 → 0.54）
- 適地面積 **-14.3%**
...
[![日本差分マップ](https://github.com/Mitsuaki-1004/coffee-2050-projection/raw/main/outputs_2050/japan_diff.png)](/Mitsuaki-1004/coffee-2050-projection/blob/main/outputs_2050/japan_diff.png)

**本州・四国・九州の山岳地帯一面に青色が広がる。** 沖縄・小笠原の現主要産地は変化なしまたは悪化。

- 沖縄やんばる 0.22 → **0.11**（既存産地は気温過剰で衰退）
...
[![主要産地比較](https://github.com/Mitsuaki-1004/coffee-2050-projection/raw/main/outputs_2050/region_score_comparison.png)](/Mitsuaki-1004/coffee-2050-projection/blob/main/outputs_2050/region_score_comparison.png)
...
4. **NDVIの限定的役割** ― 植生一般しか検出せず、コーヒーの樹そのものの分類はできていない
...
それから半年で、衛星データから世界のコーヒー産地の未来を予測できるようになりました。

**できないことが、できるようになっていく** ―― この感覚は、スターバックスで新人を育てていた時に何度も見てきたものです。改めていま、自分自身がそれを体験しています。
...
これは絶望の物語でも、楽観の物語でもなく、**「進化の物語」**です。
そしてその進化を導くのが、衛星データであり、データを読み解く人間であり、その間をつなぐ「現場を知る人間」だと、私は信じています。
